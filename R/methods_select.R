...
#' @title Select columns of a knockdown data set
#'
#' @description Takes a knockdown data set and selects columns by some
...
#' @export
#' @method select knockdown.data
#' @import data.table
#' @importFrom dplyr select_
#' @importFrom lazyeval lazy_dots
select.knockdown.data <- function(obj, ...)
{
