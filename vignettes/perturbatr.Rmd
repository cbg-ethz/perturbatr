...
using a pan-pathogenic data set of several RNAi screening studies.
...
$$y_{cgp} = x_c \beta + \gamma_g  + \delta_{cg} + \dots + \epsilon_{cgp}$$

where $y_{cgp}$ is the phenotype for a condition $c$, gene $g$ and 
