...
denv.raw        <- filter(rnai.screen.raw, Virus=="DENV", Screen=="Genome")
...
denv.norm       <- svd::preprocess(denv.raw, normalize=c( "log", "b.score",   "robust-z.score"),
                                   method="mean",
                                   z.score.level="plate",
                                   drop=T,
...
denv.priorit.h <- prioritize(denv.t.ana, hit.ratio=.5)
